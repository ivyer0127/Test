...
public class DialChart04View_hum extends GraphicalView {
	
	private String TAG = "DialChart04View";	
	private DialChart chart = new DialChart();
	private float mPercentage = 0.1f;
	
	public DialChart04View_hum(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
		initView();
	}
	
	public DialChart04View_hum(Context context, AttributeSet attrs){   
        super(context, attrs);   
        initView();
	 }
	 
	 public DialChart04View_hum(Context context, AttributeSet attrs, int defStyle) {
	...
	private void addAttrInfo() {
		...
		plotAttrInfo.addAttributeInfo(XEnum.Location.BOTTOM,"当前湿度："+
